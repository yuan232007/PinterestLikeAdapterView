...
//		File externalCacheDir = getExternalCacheDir(context);
		File externalCacheDir = new File("/sdcard/Android/data/com.huewu.pla.smaple/cache/");
		if (!externalCacheDir.exists()) {
			externalCacheDir.mkdirs();
		}
		final String cachePath = Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) || !isExternalStorageRemovable() ? externalCacheDir
	...
	public static File getExternalCacheDir(Context context) {
		...
		String cacheDir2 = Environment.getExternalStorageDirectory().getPath() + cacheDir;
		File file = new File("/sdcard/Android/data/com.huewu.pla.smaple/cache/");
		if (!file.exists()) {
			file.mkdirs();
		}
		return file;
